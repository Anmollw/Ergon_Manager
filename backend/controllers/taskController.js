...
const updateTaskStatus = async(req,res)=>{
    try{
        ...
        await task.save();
        res.json({
            message : "Task status updated", task
        });
...
const getDashboardData = async(req,res)=>{
    try{
        ...
        taskDistribution["All"] = totalTasks; // total count to taskDistribution

        //logic to include all priority lvl
...
const getUserDashboardData = async(req,res)=>{
    try{
        const userId = req.user._id // fetching data only for logged in user

        // stats for user specific task
